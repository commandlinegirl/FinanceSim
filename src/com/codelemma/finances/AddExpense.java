...
public class AddExpense extends SherlockActivity 
	...
	private int[] frequency_items = {1, 3, 6, 12, 24}; // in months
	int frequency = 1;
    ...
    private OnClickListener clickDeleteListener = new OnClickListener() {
	    ...
	    public void onClick(View v) {
	        final Expense expense = (Expense) v.getTag(R.string.acct_object);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
        ...
        Toast.makeText(getBaseContext(), "You have selected : " + frequency_items[pos], 
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if (requestCode.equals(AcctElements.UPDATE.toString())) {
	    	...
	    	Expense expense = account.getExpenseById(id); // TODO: if id == -1
	    	...
	    	inflation_rate.setText(expense.getInflationRate().toString(), TextView.BufferType.EDITABLE);
