...
public class AddIncome extends SherlockActivity
    ...
    private OnClickListener clickDeleteListener = new OnClickListener() {
	    ...
	    public void onClick(View v) {
	        final Income income = (Income) v.getTag(R.string.acct_object);
	        		   	
	        new AlertDialog.Builder(AddIncome.this)
	            .setTitle("Delete")
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
        ...
        Toast.makeText(getBaseContext(), "You have selected : " + installments_items[pos], 
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if (requestCode.equals(AcctElements.UPDATE.toString())) {
	    	...
	    	Income income = account.getIncomeById(id); // TODO: if id == -1
			...
			incomeRise.setText(income.getRiseRate().toString(), TextView.BufferType.EDITABLE);
			
			EditText incomeTaxRate = (EditText) findViewById(R.id.income_tax_rate);
			incomeTaxRate.setText(income.getTaxRate().toString(), TextView.BufferType.EDITABLE);
						
			if (income.getInstallments().doubleValue() == 13) {			
