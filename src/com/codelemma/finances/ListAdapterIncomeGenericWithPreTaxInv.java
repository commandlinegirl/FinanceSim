	...
	public class ListAdapterIncomeGenericWithPreTaxInv extends BaseExpandableListAdapter {

		private Context context;
		private ArrayList<ListGroupIncomeGeneric> groups;
		
		public ListAdapterIncomeGenericWithPreTaxInv(Context context, ArrayList<ListGroupIncomeGeneric> groups) {
		...
		private View populateView(View view, ListIncomeGeneric group) {
			...
			if (view == null) {
				...
				view = infalInflater.inflate(R.layout.list_incomegenericwithpretaxinv, null);
			}
			...
			tv = (TextView) view.findViewById(R.id.pretax_investment);
			tv.setText(group.getPreTaxInvestment().toString());
